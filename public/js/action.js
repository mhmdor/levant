$(document).ready(function() {
    ...
    const loadTotalCarBrand = () => {
        $.ajax({
            url: "/admin/total-car-brand",
            type: "GET",
            success: (data) => {
                $("#total-car-brand").html(data);
            }
        })
    }
    loadTotalCarBrand();
    ...
    const loadTotalCarFuel = () => {
        $.ajax({
            url: "/admin/total-car-fuel",
            type: "GET",
            success: (data) => {
                $("#total-car-fuel").html(data);
            }
        })
    }
    loadTotalCarFuel();
